#!/usr/bin/env python3
"""
Populate database with sample transit data
Run this after starting the Flask app or with: python populate_db.py
"""
import os
import sys
...
def populate_database():
    ...
    with app.app_context():
        ...
        print(f"  ✓ Bus Stops: 3")
        print(f"  ✓ Drivers: 3")
        print(f"  ✓ Routes: 3 (Route 101, 202, 303)")
        print(f"  ✓ Vehicles: 3 (2 operational BUS, 1 maintenance METRO)")
        print(f"  ✓ Schedules: 2")
